...
const SignIn = () => {
    ...
    const handleLogIn = e =>{
        ...
        .then((userCredential) => {
            ...
            axios.patch('https://coffee-shop-backend-1-ppmw.onrender.com/users', updatedUser)
                ...
                <div className="grid gap-8">
                    <div className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-[26px]">
                        <div
                            ...
                            <h1 className="pt-4 pb-4 font-bold dark:text-gray-400 text-5xl text-center cursor-default">Sign in</h1>
                            ...
                            <form onSubmit={handleLogIn} className="space-y-4">
                                ...
                                <a className="group text-blue-400 transition-all duration-100 ease-in-out"
                                   href="#"><span
                                    className="bg-left-bottom bg-gradient-to-r text-sm from-blue-400 to-blue-400 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">Forget your password?</span></a>
                                <button
                            ...
                            <div className="flex flex-col mt-4 items-center justify-center text-sm">
                                <h3 className="dark:text-gray-300">Do not have an account?
                                    <Link to="/signup"
                                          ...
                                          href="#">
                                        <span
                                            className="bg-left-bottom bg-gradient-to-r from-blue-400 to-blue-400 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out"> Sign Up</span>
                                    </Link>
                                </h3>
                            </div>
